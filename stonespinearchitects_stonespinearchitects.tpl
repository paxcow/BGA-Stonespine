...
<div id="main_wrapper" class="wrapper column">
  ...
  <div id="my_player_area" class="wrapper    player_area">
    ...
    <div id="my_dungeon_wrapper" class="dungeon_wrapper wrapper column">
      <div id="my_dungeon_frame_top" class="dungeon_frame" face="cave">
        dungeone frame top
      </div>
      <div id="my_dungeon" class="dungeon_grid_container">
      </div>
      <div id="my_dungeon_frame_bottom" class="dungeon_frame bottom" face="cave">
        dungeone frame bottom
      </div>
    </div>
  ...
  <div id="score_board" class="wrapper">
    ...
    <div id="market_wrapper" class="wrapper"> <!-- need a wrapper inside a wrapper to manage flexwrap-->
  ...
  <div id="player_{PLAYER_ID}_area" class="wrapper nowrap player_area">
    <div id="player_{PLAYER_ID}_hand_wrapper" class="wrapper column whiteblock">
      <h2>{PLAYER_NAME}</h2>
      <div
        id="{PLAYER_ID}_chamber_hand"
        class="wrapper player_hand_chambers"
      ></div>
      <div
        id="{PLAYER_ID}_challenge_hand"
        class="wrapper player_hand_challenges"
      ></div>
    </div>
    <div
      id="dungeon_{PLAYER_ID}_wrapper"
      class="dungeon_wrapper wrapper column"
    >
      <div id="dungeon_{PLAYER_ID}_frame_top" class="dungeon_frame" face="cave">
        dungeone frame top
      </div>
      ...
      <div
        id="dungeon_{PLAYER_ID}_frame_bottom"
        class="dungeon_frame bottom"
        face="stone"
      >
        dungeone frame bottom
      </div>
