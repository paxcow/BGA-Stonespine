...
'game_name' => "Stonespine Architects",
...
'publisher_website' => 'http://www.thunderworksgames.com/',   

// Board Game Geek ID of the publisher
'publisher_bgg_id' => 26107,
...
'tie_breaker_description' => totranslate("Priority after the last turn"),
...
'presentation' => array(
    totranslate("Stonespine Architects is a card-drafting game for 1-5 players where you compete to construct the most dangerous labyrinth."),
    totranslate("Players simultaneously draft and play cards to expand their dungeons, one chamber at a time. Follow a unique blueprint and a variety of scoring challenges."),
    totranslate("Choose between mapping a path through your underground passages, placing key elements in your rooms, or searching for extra treasure.")
